...
const (
	DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MONOCHROME   _DXGI_OUTDUPL_POINTER_SHAPE_TYPE = 0
	DXGI_OUTDUPL_POINTER_SHAPE_TYPE_COLOR        _DXGI_OUTDUPL_POINTER_SHAPE_TYPE = 1
	DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MASKED_COLOR _DXGI_OUTDUPL_POINTER_SHAPE_TYPE = 2
)
